...
class WorkspaceController {
    ...
    try {
        ...
        // Traer miembros **junto con el workspace**
        const members = await MemberWorkspaceRepository.getAllMembersByWorkspaceId(workspace._id)
        ...
        return response.json({
            ...
            data: {
                workspace: {
                    ...workspace,
                    members // <-- agregamos miembros aquí
                },
                channels
            }
        })
            ...
            await transporter.sendMail(
                {
                    ...
                    html: `<h1>El usuario: ${user.email} te ha enviado una invitación
                            ...
                            <a href='${ENVIRONMENT.URL_API_BACKEND}/api/member/confirm-invitation/${invite_token}'>
                                Click para aceptar
                            <a/>
                            `
                }
            )
console.log(`${ENVIRONMENT.URL_API_BACKEND}/api/members/confirm-invitation/TEST`)
